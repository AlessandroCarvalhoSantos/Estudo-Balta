...
public class UserController : BaseController<User>
{
  ...
  public void AddRole(int idAddRole)
  {
    ...
    userRole.UserId = idAddRole;
    userRole.RoleId = new RoleController(_connection).GetIdSearch();
    new UserRoleRepository(_connection).Create(userRole);
      
    Console.Write("Role associada a um usuário: ");
